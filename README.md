...
The outside-of-Docker tests require a working host Docker socket. The Docker-in-Docker tests require the host runtime to allow privileged containers. Secure Containers requires the host kernel to enable unprivileged user namespaces.
