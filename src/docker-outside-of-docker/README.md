...
| socketPath | Path where the host Docker socket is mounted inside the dev container. Override the matching mount target when changing this value. | string | /var/run/docker-host.sock |
